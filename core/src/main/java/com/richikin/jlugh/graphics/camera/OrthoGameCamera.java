...
public class OrthoGameCamera implements IGameCamera, Disposable
{
    ...
    /**
     * Create an {@link OrthographicCamera} with associated, separate,
     * {@link Viewport} and other data.
     * @param _sceneWidth   - The scene width in PPM units.
     * @param _sceneHeight  - The scene height in PPM units.
     * @param _viewType     - The required Viewport type from {@link ViewportType}
     * @param _name         - String holding the camera name, for debugging purposes.
     */
