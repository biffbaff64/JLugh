...
import com.richikin.jlugh.logging.StopWatch;
import com.richikin.jlugh.maths.ItemF;
...
public class ProgressBar extends ItemF implements Disposable
{
    ...
    public ProgressBar( float _speed, int size, int maxSize, String texture, boolean hasBase )
    {
        ...
        if ( hasBase )
        {
            ninePatchBase = new NinePatch( GdxApp.getAssets().getObjectRegion( texture ), 1, 1, 1, 1 );
